...
//    -----친구 성립 -----
    ...
    이렇게 가져와서 둘다 friendRepository.delete(data) 해버리면 됨*/
    ...
    public ResponseEntity<UserResponseDto.Simple> friendRequest(@ApiParam(value="타겟 유저 ID", required = true) @PathVariable Integer targetUserId){
    ...
    @ResponseStatus(value=HttpStatus.OK)
    public ResponseEntity<UserResponseDto.Simple> AcceptFriendRequest(@ApiParam(value="타겟 유저 ID", required = true) @PathVariable Integer targetUserId){
    ...
    public ResponseEntity<Void> deleteFriend(@ApiParam(value="타겟 유저 ID", required = true) @PathVariable Integer targetUserId){
    ...
    @ResponseStatus(value=HttpStatus.OK)
    public ResponseEntity<UserResponseDto.Simple> BlockFriend(@ApiParam(value="타겟 유저 ID", required = true) @PathVariable Integer targetUserId){
    ...
    @ResponseStatus(value=HttpStatus.ACCEPTED)
    public ResponseEntity<Void> deleteRequest(@ApiParam(value="타겟 유저 ID", required = true) @PathVariable Integer targetUserId){
    ...
    @ResponseStatus(value=HttpStatus.ACCEPTED)
    public ResponseEntity<Void> deleteBlock(@ApiParam(value="타겟 유저 ID", required = true) @PathVariable Integer targetUserId){
